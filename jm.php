	...
	<div class="viewport">
		<div class="background1">
			<div class = "container1">
				<header>
					<figure class="personal-image"><img src="images/face_resized.jpg" alt="Jack Mandell"></figure>
					<h1>Jack Mandell</h1>
				</header>
		...
		<div class="container2">
			...
			<section class = "extracurricular1">
				...
				<figure class = "activity1"><img src="images/art_resized.jpg" alt="art"></figure>
			</section>
			...
			<section class = "extracurricular2">
				...
				<figure class = "activity2"><img src="images/cello_resized.jpg" alt="cello"></figure>
			</section>
			...
			<section class = "extra-interest">
				...
				<figure class = "activity3"><img src="images/fishing_resized.jpg" alt="fishing"></figure>
			</section>
			...
			<footer>
				<p>CSC 174: Advanced Front-end Web Design and Development -<a href="http://csc174.org/lab01/jmandel5/lab01/" target=_blank>Original Lab 01</a></p>
			</footer>
